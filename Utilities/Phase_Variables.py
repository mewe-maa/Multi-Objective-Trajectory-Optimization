...
def getPhaseVariables(m, n, t):
    ...
    if n == 1:
        ...
        massdot = m.massdot_1[t] * m.massdot_scale  * m.mass_scale
        ...
        massdot = m.massdot_2[t] * m.massdot_scale  * m.mass_scale
        ...
        massdot = m.massdot_3[t] * m.massdot_scale  * m.mass_scale
