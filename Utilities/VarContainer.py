...
class VarContainer():
    ...
    def __init__(self, m):
        ...
        self.q0_1 = [m.q0_1[t]() * m.q0_scale for t in m.t1]
        self.q1_1 = [m.q1_1[t]() * m.q1_scale for t in m.t1]
        self.q2_1 = [m.q2_1[t]() * m.q2_scale for t in m.t1]
        self.q3_1 = [m.q3_1[t]() * m.q3_scale for t in m.t1]
        ...
        self.q0_2 = [m.q0_2[t]() * m.q0_scale for t in m.t2]
        self.q1_2 = [m.q1_2[t]() * m.q1_scale for t in m.t2]
        self.q2_2 = [m.q2_2[t]() * m.q2_scale for t in m.t2]
        self.q3_2 = [m.q3_2[t]() * m.q3_scale for t in m.t2]
        ...
        self.q0_3 = [m.q0_3[t]() * m.q0_scale for t in m.t3]
        self.q1_3 = [m.q1_3[t]() * m.q1_scale for t in m.t3]
        self.q2_3 = [m.q2_3[t]() * m.q2_scale for t in m.t3]
        self.q3_3 = [m.q3_3[t]() * m.q3_scale for t in m.t3]
