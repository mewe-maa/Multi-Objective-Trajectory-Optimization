...
def getPhaseVariables(m, n, t):
    ...
    if n == 1:
        ...
        # mpayload = m.mpayload_1[t] * m.mass_scale
        mpayload = m.mpayload* m.mpayload_scale

        mfuel = m.mfuel_1[t] * m.mfuel_scale

        massdot = m.massdot_1[t] * m.mfuel_scale * m.massdot_scale
        dmass_dtau = m.dmass_dtau_1[t] * m.mfuel_scale
        ...
        delta = m.delta_1[t] * m.delta_scale 
        gamma = m.gamma_1[t] * m.gamma_scale 
        ...
        dq0_dtau = m.dq0_dtau_2[t] * m.q0_scale
        dq1_dtau = m.dq1_dtau_2[t] * m.q1_scale
        dq2_dtau = m.dq2_dtau_2[t] * m.q2_scale
        dq3_dtau = m.dq3_dtau_2[t] * m.q3_scale

        q0dot = m.q0dot_2[t] * m.q0_scale * m.q0dot_scale
        q1dot = m.q1dot_2[t] * m.q1_scale * m.q1dot_scale
        q2dot = m.q2dot_2[t] * m.q2_scale * m.q2dot_scale
        q3dot = m.q3dot_2[t] * m.q3_scale * m.q3dot_scale

        mass = m.mass_2[t] * m.mass_scale
        # mpayload = m.mpayload_2[t] * m.mass_scale
        mpayload = m.mpayload* m.mpayload_scale

        mfuel = m.mfuel_2[t] * m.mfuel_scale

        massdot = m.massdot_2[t] * m.mfuel_scale * m.massdot_scale
        dmass_dtau = m.dmass_dtau_2[t] * m.mfuel_scale
        ...
        delta = m.delta_2[t] * m.delta_scale 
        gamma = m.gamma_2[t] * m.gamma_scale 
        ...
        dq0_dtau = m.dq0_dtau_3[t] * m.q0_scale
        dq1_dtau = m.dq1_dtau_3[t] * m.q1_scale
        dq2_dtau = m.dq2_dtau_3[t] * m.q2_scale
        dq3_dtau = m.dq3_dtau_3[t] * m.q3_scale

        q0dot = m.q0dot_3[t] * m.q0_scale * m.q0dot_scale
        q1dot = m.q1dot_3[t] * m.q1_scale * m.q1dot_scale
        q2dot = m.q2dot_3[t] * m.q2_scale * m.q2dot_scale
        q3dot = m.q3dot_3[t] * m.q3_scale * m.q3dot_scale
        ...
        # mpayload = m.mpayload_3[t] * m.mass_scale
        mpayload = m.mpayload* m.mpayload_scale

        mfuel = m.mfuel_3[t] * m.mfuel_scale
        
        massdot = m.massdot_3[t] * m.mfuel_scale * m.massdot_scale
        dmass_dtau = m.dmass_dtau_3[t] * m.mfuel_scale
        ...
        delta = m.delta_3[t] * m.delta_scale 
        gamma = m.gamma_3[t] * m.gamma_scale 
