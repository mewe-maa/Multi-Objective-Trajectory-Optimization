...
class VarContainer():
    ...
    def __init__(self, m):
        ...
        # self.q0dot_1 = [m.q0dot_1[t]() * m.q0_scale * m.q0dot_scale for t in m.t1]
        # self.q1dot_1 = [m.q1dot_1[t]() * m.q1_scale * m.q1dot_scale for t in m.t1]
        # self.q2dot_1 = [m.q2dot_1[t]() * m.q2_scale * m.q2dot_scale for t in m.t1]
        # self.q3dot_1 = [m.q3dot_1[t]() * m.q3_scale * m.q3dot_scale for t in m.t1]
